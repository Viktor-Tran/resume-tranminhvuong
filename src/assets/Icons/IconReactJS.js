...
const IconReact = () => {
  return (
    ...
    >
      ...
      <path
        fill="url(#rQqjnSUGxprE2SEHQ~MXkb_p57acgidi9bj_gr1)"
        d="M32,45C15.467,45,3,39.411,3,32s12.467-13,29-13c16.532,0,29,5.589,29,13S48.532,45,32,45z M32,23c-14.309,0-25,4.751-25,9c0,4.248,10.691,9,25,9s25-4.752,25-9C57,27.751,46.309,23,32,23z"
      ></path>
      <linearGradient
        id="rQqjnSUGxprE2SEHQ~MXkc_p57acgidi9bj_gr2"
        x1="31.999"
        x2="31.999"
        y1="58.191"
        y2="5.21"
      ...
      <path
        fill="url(#rQqjnSUGxprE2SEHQ~MXkd_p57acgidi9bj_gr3)"
        d="M21.01,58.017c-1.274,0-2.456-0.292-3.511-0.901c-3.295-1.903-4.632-6.428-3.763-12.742	c0.785-5.706,3.272-12.408,7.005-18.872l0,0c3.732-6.464,8.293-11.97,12.842-15.502c5.032-3.91,9.619-5.016,12.916-3.112	c3.296,1.902,4.633,6.428,3.764,12.742c-0.785,5.706-3.272,12.408-7.005,18.872C36.351,50.463,27.484,58.017,21.01,58.017z M24.205,27.501c-3.479,6.026-5.79,12.212-6.506,17.417c-0.614,4.463,0.059,7.728,1.8,8.732c3.681,2.129,13.141-4.758,20.294-17.149	c3.48-6.027,5.791-12.212,6.507-17.417c0.614-4.462-0.059-7.727-1.801-8.733c-1.738-1.004-4.904,0.044-8.463,2.807	C31.887,16.38,27.685,21.474,24.205,27.501L24.205,27.501z"
      ></path>
      <linearGradient
        id="rQqjnSUGxprE2SEHQ~MXke_p57acgidi9bj_gr4"
        x1="32"
        x2="32"
        y1="29"
        y2="39"
      ...
      <circle
        ...
        cy="32"
        r="5"
        fill="url(#rQqjnSUGxprE2SEHQ~MXke_p57acgidi9bj_gr4)"
      ></circle>
    </svg>
  );
};
